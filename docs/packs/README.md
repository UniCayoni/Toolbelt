...
| **Plan** | shipped (Theme 6 accept + elevate) | `implementation-plan`; template `docs/templates/plan-minimal.md`; house path `docs/plans/`; rule `draft-is-not-sot` (draft plans ≠ law). See `docs/research/reports/theme-6-plan-pocket.md` |
| **Execute** | shipped (Theme 7 accept + elevate) | `implementation-execute`, `implementation-execute-subagents`; consumes `docs/plans/` + Theme 6 Plan law. See `docs/research/reports/theme-7-execute-pocket.md` |
| Quality / Verify / workflow | stub | future — may be pocket **or** touchups on Plan/Execute (+ Debug); T7D portable notes |

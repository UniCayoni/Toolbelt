...
| **Happy path** | shipped (Theme 10; composition Theme 14) | `implementation-happy-path`; template `docs/templates/happy-path.md`; caller of pocket routers (compose only). See `docs/research/reports/theme-10-happy-path.md` + Theme 14 |

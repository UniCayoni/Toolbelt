...
**Prompt:** “Using `research-codebase-recon` (as-needed), map d:\\Toolbelt plugin layout: skills count, rules count, where PROTOCOL.md lives, and whether `research-scope` skill exists. Short checklist findings only.”

...
| C5 | Enough-to-start proposes human gate | pending/accept language | |
| C6 | Handoffs to research skills (not graded-note theater) | Names protocol/recon/docs | |

## Anti-patterns

| # | Must not | Observed? |
|---|----------|-----------|
| A1 | Become second research-protocol (full Method+grades theater) | |
| A2 | Conflate concept atoms with D11 checkable doc atoms | |
| A3 | Treat unaccepted scope as design law | |

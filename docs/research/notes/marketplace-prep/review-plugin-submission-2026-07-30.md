...
|-----------|---------|-------|
| Skills `skills/*/SKILL.md` | **22** | PASS (incl. closeout + routers) |
...
| Check | Result |
|-------|--------|
| Skills: `name` + `description`; `name` == folder | **22/22** PASS |
...
| 4 | `CHANGELOG.md` | **done** |
| 5 | Local sync + Reload smoke (Customize → Plugins → skills count **22**) | **operator** |
...
6. [ ] **Reload Window**; smoke Customize → Plugins → **22** skills; spot-check `/implementation-closeout` or `/implementation-router`  

---
title: "Theme 12 — Research scope companion (integrated report)"
status: accepted
theme: theme-12-research-scoping
created: 2026-07-31
updated: 2026-07-31
accepted: 2026-07-31
acceptance_scope: method_guidance_t12_research_scope
...
**Using `author-cursor-surfaces`** · elevate.
...
| D7 | Happy-path / protocol / recon / docs = **Handoffs only** |
| D8 | `research-protocol` stays notes/grades/depth — no scoping spine inside it |
| D9 | Parks: no always-on rule; no mega-skill; no S0–S18/D0–D14 rewrite |
...
[`scope-normal-pass1.md`](../notes/theme-12-research-scoping/scope-normal-pass1.md), [`campaign-brief.md`](../notes/theme-12-research-scoping/campaign-brief.md), Theme 5 campaign-brief pattern (E0), Themes 1–3 / 10 reports, `research-depth-modes`.

...
description: >-
  ...
  slices — not story, not world bible, not product UX. Formerly
...
**Out:** Narrative/quests → `design-narrative`. World/characters → `design-world-character`. Code architecture → `design-technical` (**do not** apply MDA as Clean Architecture). Engines/stack locks. Product UX (T5C).
...
- Read `references/design-systems-checklist.md` **when** running a full systems pass

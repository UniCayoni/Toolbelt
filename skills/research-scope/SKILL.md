...
- Concept is fuzzy; tracks or questions are unclear
- Theme / multi-surface / campaign research before gather
...
| Term | Means | Not |
|------|--------|-----|
| **Concept atom** | Researchable piece → a **track** | T3 D11 path/API “checkable atom” |
| **Complexity** | simple \| complex \| theme/campaign | Depth mode |
| **Depth** | normal \| deep (owned by `research-protocol`) | Complexity |
...
- [ ] Next skills named; no graded-note theater inside this skill

## Anti-patterns

- Becoming a second `research-protocol`
- Mandatory scope on every research call
- Conflating concept atoms with D11 checkable doc atoms
